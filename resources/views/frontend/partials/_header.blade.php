              ...
              <div class="row">
                 ...
                 <div class="col-md-3">
                    <ul class="nav navbar-nav navbar-right">
                      @if ( Auth::user()->check() )
                          <li><a href={{ url("logout") }}><span class="glyphicon glyphicon-log-out"></span> logout <span style="font-family:'open sans condensed', sans-serif; font-weight:normal; text-transform: lowercase;"></span></a></li>
                      @else
                  ...
                  <ul class="nav navbar-nav navbar-right">
                    ...
                    @if ( Auth::user()->check() )
                        ...
                        @if (Auth::user()->user()->membership->type == 'institutional')
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-star"></span>Events <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href={{ route('memberViewAll') }}>View All</a>
                                    </li>
                                    <li>
                                        <a href={{ route('createEvent') }}>Create</a>
                                    </li>
                                    <li>
                                        <a href={{ route('myEventList') }}>My Events</a>
                                    </li>
                        ...
                        @else
                             <li>
                                <a href={{ route('memberViewAll') }}><span class="glyphicon glyphicon-star"></span>Events</a>
                            </li>
                        @endif
                    ...
                    @else                                    
                        <li class="dropdown">
                         ...
                         <li>
                            <a href={{ route('guestViewAll') }}><span class="glyphicon glyphicon-star"></span>Events</a>
                        </li>
                    @endif
                  </ul>
                </div>
